...
$string['pushitems_details'] = 'The items in this MiniLesson will be pushed to matching MiniLessons. It will only push to MiniLessons whose items type, order, name ALL match. It is intended to overwrite only existing items of MiniLesson activities that are already clones of this MiniLesson. It wont push files';
