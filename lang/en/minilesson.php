...
$string['relevancetype_question'] = 'Relevance to the Question';
...
$string['pr_alternates_instructions'] =  'Specify matching options for specific passage words. 1 word set per line. e.g their|there|they\'re See <a href="https://support.poodll.com/support/solutions/articles/19000096937-tuning-your-read-aloud-activity">docs</a> for more details.';
...
$string['finishscreencustom'] = "Custom Finish Screen Code";
...
$string['pushpage_explanation'] = "Use the buttons on this page to push settings from this MiniLesson instance to other MiniLesson activities. Be careful. There is no going back. So be sure of your intention before using.";
...
$string['pushpage_noclones'] = 'This activity IS a master instance, but there are no other activities are in the affected scope. So there is nothing to push settings to. Check that your target MiniLesson are not set as Master instances<br><br>';
$string['pushpage_done'] = 'Settings pushed to {$a} MiniLesson activities';
$string['pushmode_none'] = 'NOT a master instance';
$string['pushmode_modulename'] = 'for MiniLesson activities with this activity name';
$string['pushmode_course'] = 'for MiniLesson activities in this course';
$string['pushmode_site'] = 'for all MiniLesson activities sitewide';
$string['pushpage_scopemodule'] = 'Scope: MiniLesson activities (sitewide) with this activity name: {$a}';
$string['pushpage_scopecourse'] = 'Scope: MiniLesson activities in this course: {$a}';
$string['pushpage_scopesite'] = 'Scope: All MiniLesson activities SITEWIDE';
$string['pushpage_scopenone'] = 'Scope: NO MiniLesson activities';
$string['scopeselector']  = 'Scope Selector';