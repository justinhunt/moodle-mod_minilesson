...
$string['freespeakingdesc'] ='Set target word count and grading and feedback guidelines for the AI evaluation.';
...
$string['passagereadingdesc'] ='Enter a passage to read in the text area below. The student should read the passage.';
