...
$string['audiochat_instructions_default'] = 'You are {ai role}. You are teaching {target language}. The student is a native speaker of {native language}. Today the discussion topic is: {topic}. Please discuss it with your student. Speak simply and slowly. Your responses should be brief. Your aim is to give the student opportunity to speak. Explain words and concepts in the student\'s native language if they do not understand. ';
$string['audiochat_instructions_instructions'] = 'The instructions are a template that combines with the AI role, topic and student native language, that you entered above, to create the instructions passed to AI. You can use the following variables in the instructions: {ai role}, {target language}, {native language} and {topic}. The default instructions are usually fine. But you can change them if you have a different use case.';
...
$string['zoomandpanlite'] = 'light';
$string['zoomandpanmedium'] = 'medium';
$string['zoomandpanmore'] = 'more';