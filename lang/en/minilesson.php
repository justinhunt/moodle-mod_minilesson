...
$string["exportandtranslateinstructions"]='Export and translate items in this MiniLesson activity to a JSON file. This can be used to backup or transfer items to another MiniLesson activity. Or you can edit the exported items and re-import them as new items.';
