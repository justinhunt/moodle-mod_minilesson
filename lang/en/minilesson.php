...
$string['aigentemplatename:reading_aic_passagegen'] = 'Reading + Chat (AI passage)';
...
$string['aigentemplatedescription:keywordstogapfillsfluency'] = 'Enter a list of words (maximum 10) and Poodll will make a short activity for students to practice those words';
