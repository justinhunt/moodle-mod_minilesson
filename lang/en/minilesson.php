...
$string['managemcp_enablebody'] = 'To allow someone to use MCP, assign them a role that carries the mod/minilesson:usemcp capability at system context. By default that\'s the "{$a}" role created below. The user will also need a web service token, and touse it with an MCP-compatible agent.';
