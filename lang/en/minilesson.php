...
$string['freewriting_default_aigrade'] = 'Deduct 1 point for each grammar mistake but do not penalize for spelling or punctuation errors.';
$string['freewriting_default_aigradefeedback']  = 'Explain each grammar mistake simply.';
