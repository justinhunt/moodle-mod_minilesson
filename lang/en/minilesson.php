...
$string['aigentemplatename:reading_aic_passagegen'] = 'Reading + Audio Chat (Generated passage)';
$string['aigentemplatename:reading_aic_passageupload'] = 'Reading + Audio Chat (Uploaded passage) ';
...
$string['aigentemplatename:narrativefiction_withpics'] = 'Narrative Interactive Fiction (with pictures)';
...
$string['aigentemplatedescription:fiction_nopics'] = 'Enter a detailed story outline to get a text-only interactive fiction activity (with a single poster image).';
$string['aigentemplatedescription:narrativefiction_withpics'] = 'Enter a detailed story outline to get an interactive fiction activity  with fewer choices, more story, and pictures.';
$string['aigentemplatedescription:vocabcards'] = 'A list of vocabulary cards. Enter the list of comma separated words/phrases, and the students\' native language. Cards with the word/phrase, translation, example sentence and a picture will be created.';
