...
$string['addqcarditem']='Question Card';
$string['qcard']='Question Card';
$string['qcard_instructions1'] = 'Listen and type each sentence that you hear.';
$string['qcardbuttontext']='Caption';
$string['qcardbuttonaction']='Action';
$string['qcardbuttonactiontarget']='Action Target';
$string['qcardbuttonentryanim']='Entry Anim';
$string['qcardbuttonimage']='Image';
$string['qcardbuttons']='Choice Buttons';
$string['qcardbuttonno']='Button {no}:';
$string['cardtype']='Card Type';
$string['bgimage']='Background Image';
$string['timelimit']='Time Limit (seconds)';
$string['entryanim']='Entry Anim';
