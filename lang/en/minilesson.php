...
$string['aigentemplatename:passagereading'] = 'Passage Reading';
...
$string['aigentemplatename:dialog_multichoice'] = 'Dialog Multi-Choice';
...
$string['aigentemplatedescription:reading_aic_passagegen'] = 'This will take a topic and learner level and generate a reading passage that will be used in a passage reading and then an audio chat session';
$string['aigentemplatedescription:reading_aic_passageupload'] = 'Paste in a reading passage, and 4 short answer questions. These will be used in a passage reading exercise and then an audio chat session';
$string['aigentemplatedescription:keywords_to_ws_sc'] = 'Enter 4 - 10 keywords. The keywords will be used to generate a word shuffle and scatter activity. The keywords will also be used to generate a picture of each keyword on a blackboard with a cute cat teacher beside it.';
$string['aigentemplatedescription:keywords_to_ws_sc_sg'] = 'Enter 4 - 10 keywords. The keywords will be used to generate a word shuffle and scatter activity, and a space game activity. The keywords will also be used to generate a picture of each keyword on a blackboard with a cute poodle teacher beside it.';
$string['aigentemplatedescription:dialog_multichoice'] = 'Enter 4 dialogs in TTS Dialog format. They will form 4 multi choice questions where the choice of answer is an image representing the currently playing TTS Dialog.';
...
$string['wordshuffledesc'] ='Enter the list of items in the text area below. Each item should be on a new line.';
...
$string['item_wordshuffle_desc'] = 'The Word Shuffle item takes a set ofsentences The words in each sentence are re-arranged. The student must order the words correctly.';
