...
class constants {
    ...
    const ALL_VOICES = [
        self::M_LANG_ARAE => ['Hala' => 'Hala', 'Zayd' => 'Zayd', 'ar-AE-Whisper-alloy' => 'Alloy (ar)', 'ar-AE-Whisper-shimmer' => 'Shimmer (ar)', 'ar-AE-Whisper-nova' => 'Nova (ar)'],
        self::M_LANG_ARSA => ['Zeina' => 'Zeina', 'ar-MA-Azure-JamalNeural' => 'Jamal_a', 'ar-XA-Wavenet-B' => 'Amir_g', 'ar-XA-Wavenet-A' => 'Salma_g', 'ar-MA-Azure-MounaNeural' => 'Mouna_a', 'ar-SA-Whisper-alloy' => 'Alloy (ar)', 'ar-SA-Whisper-shimmer' => 'Shimmer (ar)', 'ar-SA-Whisper-nova' => 'Nova (ar)'],
        self::M_LANG_BGBG => ['bg-BG-Standard-A' => 'Mila_g', 'bg-BG-Whisper-alloy' => 'Alloy (bg)', 'bg-BG-Whisper-shimmer' => 'Shimmer (bg)', 'bg-BG-Whisper-nova' => 'Nova (bg)'], // nikolai
        ...
        self::M_LANG_ENGB => ['Brian' => 'Brian', 'Amy' => 'Amy', 'Emma' => 'Emma', 'Arthur' => 'Arthur', 'en-GB-Whisper-alloy' => 'Alloy (en)', 'en-GB-Whisper-shimmer' => 'Shimmer (en)', 'en-GB-Whisper-nova' => 'Nova (en)'],
        self::M_LANG_ENAU => ['Russell' => 'Russell', 'Nicole' => 'Nicole', 'Olivia' => 'Olivia', 'en-AU-Whisper-alloy' => 'Alloy (en)', 'en-AU-Whisper-shimmer' => 'Shimmer (en)', 'en-AU-Whisper-nova' => 'Nova (en)'],
        self::M_LANG_ENNZ => ['Aria' => 'Aria', 'en-NZ-Whisper-alloy' => 'Alloy (en)', 'en-NZ-Whisper-shimmer' => 'Shimmer (en)', 'en-NZ-Whisper-nova' => 'Nova (en)'],
        self::M_LANG_ENZA => ['Ayanda' => 'Ayanda', 'en-ZA-Whisper-alloy' => 'Alloy (en)', 'en-ZA-Whisper-shimmer' => 'Shimmer (en)', 'en-ZA-Whisper-nova' => 'Nova (en)'],
        self::M_LANG_ENIN => ['Aditi' => 'Aditi', 'Raveena' => 'Raveena', 'Kajal' => 'Kajal', 'en-IN-Whisper-alloy' => 'Alloy (en)', 'en-IN-Whisper-shimmer' => 'Shimmer (en)', 'en-IN-Whisper-nova' => 'Nova (en)'],
            // constants::M_LANG_ENIE => [],
        self::M_LANG_ENWL => ["Geraint" => "Geraint", 'en-WL-Whisper-alloy' => 'Alloy (en)', 'en-WL-Whisper-shimmer' => 'Shimmer (en)', 'en-WL-Whisper-nova' => 'Nova (en)'],
            // constants::M_LANG_ENAB => [],
        self::M_LANG_FILPH => ['fil-PH-Wavenet-A' => 'Darna_g', 'fil-PH-Wavenet-B' => 'Reyna_g', 'fil-PH-Wavenet-C' => 'Bayani_g', 'fil-PH-Wavenet-D' => 'Ernesto_g', 'fil-PH-Whisper-alloy' => 'Alloy (fil)', 'fil-PH-Whisper-shimmer' => 'Shimmer (fil)', 'fil-PH-Whisper-nova' => 'Nova (fil)'],
        self::M_LANG_FIFI => ['Suvi' => 'Suvi', 'fi-FI-Wavenet-A' => 'Kaarina_g', 'fi-FI-Whisper-alloy' => 'Alloy (fi)', 'fi-FI-Whisper-shimmer' => 'Shimmer (fi)', 'fi-FI-Whisper-nova' => 'Nova (fi)'],
        self::M_LANG_FRCA => ['Chantal' => 'Chantal', 'Gabrielle' => 'Gabrielle', 'Liam' => 'Liam', 'fr-CA-Whisper-alloy' => 'Alloy (fr)', 'fr-CA-Whisper-shimmer' => 'Shimmer (fr)', 'fr-CA-Whisper-nova' => 'Nova (fr)'],
        self::M_LANG_FRFR => ['Mathieu' => 'Mathieu', 'Celine' => 'Celine', 'Lea' => 'Lea', 'Remi' => 'Remi', 'fr-FR-Whisper-alloy' => 'Alloy (fr)', 'fr-FR-Whisper-shimmer' => 'Shimmer (fr)', 'fr-FR-Whisper-nova' => 'Nova (fr)'],
        self::M_LANG_DEDE => ['Hans' => 'Hans', 'Marlene' => 'Marlene', 'Vicki' => 'Vicki', 'Daniel' => 'Daniel', 'de-DE-Whisper-alloy' => 'Alloy (de)', 'de-DE-Whisper-shimmer' => 'Shimmer (de)', 'de-DE-Whisper-nova' => 'Nova (de)'],
        self::M_LANG_DEAT => ['Hannah' => 'Hannah', 'de-AT-Whisper-alloy' => 'Alloy (de)', 'de-AT-Whisper-shimmer' => 'Shimmer (de)', 'de-AT-Whisper-nova' => 'Nova (de)'],
        self::M_LANG_ELGR => ['el-GR-Wavenet-A' => 'Sophia_g', 'el-GR-Standard-A' => 'Isabella_g', 'el-GR-Whisper-alloy' => 'Alloy (el)', 'el-GR-Whisper-shimmer' => 'Shimmer (el)', 'el-GR-Whisper-nova' => 'Nova (el)'],
        self::M_LANG_HIIN => ["Aditi" => "Aditi", 'hi-IN-Whisper-alloy' => 'Alloy (hi)', 'hi-IN-Whisper-shimmer' => 'Shimmer (hi)', 'hi-IN-Whisper-nova' => 'Nova (hi)'],
        self::M_LANG_HEIL => ['he-IL-Wavenet-A' => 'Sarah_g', 'he-IL-Wavenet-B' => 'Noah_g', 'he-IL-Whisper-alloy' => 'Alloy (he)', 'he-IL-Whisper-shimmer' => 'Shimmer (he)', 'he-IL-Whisper-nova' => 'Nova (he)'],
        self::M_LANG_HUHU => ['hu-HU-Wavenet-A' => 'Eszter_g', 'hu-HU-Whisper-alloy' => 'Alloy (hu)', 'hu-HU-Whisper-shimmer' => 'Shimmer (hu)', 'hu-HU-Whisper-nova' => 'Nova (hu)'],

        self::M_LANG_IDID => ['id-ID-Wavenet-A' => 'Guntur_g', 'id-ID-Wavenet-B' => 'Bhoomik_g', 'id-ID-Whisper-alloy' => 'Alloy (id)', 'id-ID-Whisper-shimmer' => 'Shimmer (id)', 'id-ID-Whisper-nova' => 'Nova (id)'],
        self::M_LANG_ISIS => ['Dora' => 'Dora', 'Karl' => 'Karl', 'is-IS-Whisper-alloy' => 'Alloy (is)', 'is-IS-Whisper-shimmer' => 'Shimmer (is)', 'is-IS-Whisper-nova' => 'Nova (is)'],
        self::M_LANG_ITIT => ['Carla' => 'Carla', 'Bianca' => 'Bianca', 'Giorgio' => 'Giorgio', 'it-IT-Whisper-alloy' => 'Alloy (it)', 'it-IT-Whisper-shimmer' => 'Shimmer (it)', 'it-IT-Whisper-nova' => 'Nova (it)'],
        self::M_LANG_JAJP => ['Takumi' => 'Takumi', 'Mizuki' => 'Mizuki', 'Kazuha' => 'Kazuha', 'Tomoko' => 'Tomoko', 'ja-JP-Whisper-alloy' => 'Alloy (ja)', 'ja-JP-Whisper-shimmer' => 'Shimmer (ja)', 'ja-JP-Whisper-nova' => 'Nova (ja)'],
        self::M_LANG_KOKR => ['Seoyeon' => 'Seoyeon', 'ko-KR-Whisper-alloy' => 'Alloy (ko)', 'ko-KR-Whisper-shimmer' => 'Shimmer (ko)', 'ko-KR-Whisper-nova' => 'Nova (ko)'],
        self::M_LANG_LVLV => ['lv-LV-Standard-A' => 'Janis_g', 'lv-LV-Whisper-alloy' => 'Alloy (lv)', 'lv-LV-Whisper-shimmer' => 'Shimmer (lv)', 'lv-LV-Whisper-nova' => 'Nova (lv)'],
        self::M_LANG_LTLT => ['lt-LT-Standard-A' => 'Matas_g', 'lt-LT-Whisper-alloy' => 'Alloy (lt)', 'lt-LT-Whisper-shimmer' => 'Shimmer (lt)', 'lt-LT-Whisper-nova' => 'Nova (lt)'],
        self::M_LANG_MINZ => ['mi-NZ-Whisper-alloy' => 'Tane', 'mi-NZ-Whisper-shimmer' => 'Aroha', 'mi-NZ-Whisper-nova' => 'Nova (mi)'],
        self::M_LANG_MKMK => ['mk-MK-Whisper-alloy' => 'Trajko', 'mk-MK-Whisper-shimmer' => 'Marija', 'mk-MK-Whisper-nova' => 'Nova (mk)'],
        self::M_LANG_MSMY => ['ms-MY-Whisper-alloy' => 'Afsah', 'ms-MY-Whisper-shimmer' => 'Siti', 'ms-MY-Whisper-nova' => 'Nova (ms)'],
        self::M_LANG_NONO => ['Liv' => 'Liv', 'Ida' => 'Ida', 'nb-NO-Wavenet-B' => 'Lars_g', 'nb-NO-Wavenet-A' => 'Hedda_g', 'nb-NO-Wavenet-D' => 'Anders_g', 'no-NO-Whisper-alloy' => 'Alloy (no)', 'no-NO-Whisper-shimmer' => 'Shimmer (no)', 'no-NO-Whisper-nova' => 'Nova (no)'],
        self::M_LANG_PSAF => ['ps-AF-Azure-GulNawazNeural' => 'GulNawaz_a', 'ps-AF-Azure-LatifaNeural' => 'Latifa_a', 'ps-AF-Whisper-alloy' => 'Alloy (ps)', 'ps-AF-Whisper-shimmer' => 'Shimmer (ps)', 'ps-AF-Whisper-nova' => 'Nova (ps)'],
        self::M_LANG_FAIR => ['fa-IR-Azure-FaridNeural' => 'Farid_a', 'fa-IR-Azure-DilaraNeural' => 'Dilara_a', 'fa-IR-Whisper-alloy' => 'Alloy (fa)', 'fa-IR-Whisper-shimmer' => 'Shimmer (fa)', 'fa-IR-Whisper-nova' => 'Nova (fa)'],
        self::M_LANG_PLPL => ['Ewa' => 'Ewa', 'Maja' => 'Maja', 'Jacek' => 'Jacek', 'Jan' => 'Jan', 'pl-PL-Whisper-alloy' => 'Alloy (pl)', 'pl-PL-Whisper-shimmer' => 'Shimmer (pl)', 'pl-PL-Whisper-nova' => 'Nova (pl)'],
        self::M_LANG_PTBR => ['Ricardo' => 'Ricardo', 'Vitoria' => 'Vitoria', 'Camila' => 'Camila', 'pt-BR-Whisper-alloy' => 'Alloy (pt)', 'pt-BR-Whisper-shimmer' => 'Shimmer (pt)', 'pt-BR-Whisper-nova' => 'Nova (pt)'],
        self::M_LANG_PTPT => ["Ines" => "Ines", 'Cristiano' => 'Cristiano', 'pt-PT-Whisper-alloy' => 'Alloy (pt)', 'pt-PT-Whisper-shimmer' => 'Shimmer (pt)', 'pt-PT-Whisper-nova' => 'Nova (pt)'],
        self::M_LANG_RORO => ['Carmen' => 'Carmen', 'ro-RO-Wavenet-A' => 'Sorina_g', 'ro-RO-Whisper-alloy' => 'Alloy (ro)', 'ro-RO-Whisper-shimmer' => 'Shimmer (ro)', 'ro-RO-Whisper-nova' => 'Nova (ro)'],
        self::M_LANG_RURU => ["Tatyana" => "Tatyana", "Maxim" => "Maxim", "ru-RU-Azure-SvetlanaNeural" => 'Svetlana_a', "ru-RU-Azure-DmitryNeural" => "Dmitry_a", "ru-RU-Azure-DariyaNeural" => "Dariya_a", 'ru-RU-Whisper-alloy' => 'Alloy (ru)', 'ru-RU-Whisper-shimmer' => 'Shimmer (ru)', 'ru-RU-Whisper-nova' => 'Nova (ru)'],
        self::M_LANG_ESUS => ['Miguel' => 'Miguel', 'Penelope' => 'Penelope', 'Lupe' => 'Lupe', 'Pedro' => 'Pedro', 'es-US-Whisper-alloy' => 'Alloy (es)', 'es-US-Whisper-shimmer' => 'Shimmer (es)', 'es-US-Whisper-nova' => 'Nova (es)'],
        self::M_LANG_ESES => ['Enrique' => 'Enrique', 'Conchita' => 'Conchita', 'Lucia' => 'Lucia', 'es-ES-Whisper-alloy' => 'Alloy (es)', 'es-ES-Whisper-shimmer' => 'Shimmer (es)', 'es-ES-Whisper-nova' => 'Nova (es)'],
        self::M_LANG_SVSE => ['Astrid' => 'Astrid', 'Elin' => 'Elin', 'sv-SE-Whisper-alloy' => 'Alloy (sv)', 'sv-SE-Whisper-shimmer' => 'Shimmer (sv)', 'sv-SE-Whisper-nova' => 'Nova (sv)'],
        self::M_LANG_SKSK => ['sk-SK-Wavenet-A' => 'Laura_g', 'sk-SK-Standard-A' => 'Natalia_g', 'sk-SK-Whisper-alloy' => 'Alloy (sk)', 'sk-SK-Whisper-shimmer' => 'Shimmer (sk)', 'sk-SK-Whisper-nova' => 'Nova (sk)'],
        self::M_LANG_SLSI => ['sl-SI-Whisper-alloy' => 'Vid', 'sl-SI-Whisper-shimmer' => 'Pia', 'sl-SI-Whisper-nova' => 'Nova (sl)'],
        self::M_LANG_SOSO => ['so-SO-Azure-UbaxNeural' => 'Ubax_a', 'so-SO-Azure-MuuseNeural' => 'Muuse_a', 'so-SO-Whisper-alloy' => 'Alloy (so)', 'so-SO-Whisper-shimmer' => 'Shimmer (so)', 'so-SO-Whisper-nova' => 'Nova (so)'],
        self::M_LANG_SRRS => ['sr-RS-Standard-A' => 'Milena_g', 'sr-RS-Whisper-alloy' => 'Alloy (sr)', 'sr-RS-Whisper-shimmer' => 'Shimmer (sr)', 'sr-RS-Whisper-nova' => 'Nova (sr)'],
        self::M_LANG_TAIN => ['ta-IN-Wavenet-A' => 'Dyuthi_g', 'ta-IN-Wavenet-B' => 'Bhoomik_g', 'ta-IN-Whisper-alloy' => 'Alloy (ta)', 'ta-IN-Whisper-shimmer' => 'Shimmer (ta)', 'ta-IN-Whisper-nova' => 'Nova (ta)'],
        self::M_LANG_TEIN => ['te-IN-Standard-A' => 'Anandi_g', 'te-IN-Standard-B' => 'Kai_g', 'te-IN-Whisper-alloy' => 'Alloy (te)', 'te-IN-Whisper-shimmer' => 'Shimmer (te)', 'te-IN-Whisper-nova' => 'Nova (te)'],
        self::M_LANG_TRTR => ['Filiz' => 'Filiz', 'tr-TR-Whisper-alloy' => 'Alloy (tr)', 'tr-TR-Whisper-shimmer' => 'Shimmer (tr)', 'tr-TR-Whisper-nova' => 'Nova (tr)'],
        self::M_LANG_UKUA => ['uk-UA-Wavenet-A' => 'Katya_g', 'uk-UA-Whisper-alloy' => 'Alloy (uk)', 'uk-UA-Whisper-shimmer' => 'Shimmer (uk)', 'uk-UA-Whisper-nova' => 'Nova (uk)'],
        self::M_LANG_VIVN => ['vi-VN-Wavenet-A' => 'Huyen_g', 'vi-VN-Wavenet-B' => 'Duy_g', 'vi-VN-Whisper-alloy' => 'Alloy (vi)', 'vi-VN-Whisper-shimmer' => 'Shimmer (vi)', 'vi-VN-Whisper-nova' => 'Nova (vi)'],
    ];
